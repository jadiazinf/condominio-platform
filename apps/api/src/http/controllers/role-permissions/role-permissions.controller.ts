    ...
    return [
      ...
      },
      {
        ...
        middlewares: [
          ...
          paramsValidator(RoleIdParamSchema),
        ],
      },
      {
        method: 'get',
        ...
        middlewares: [
          authMiddleware,
          requireRole(ESystemRole.SUPERADMIN),
          paramsValidator(PermissionIdParamSchema),
        ],
      },
      {
        method: 'get',
        ...
        middlewares: [
          authMiddleware,
          requireRole(ESystemRole.SUPERADMIN),
          paramsValidator(RoleAndPermissionParamSchema),
        ],
      },
      {
        method: 'get',
      ...
      },
      {
        ...
        middlewares: [
          authMiddleware,
          requireRole(ESystemRole.SUPERADMIN),
          bodyValidator(rolePermissionCreateSchema),
        ],
      },
      {
        method: 'patch',
        ...
        middlewares: [
          ...
          requireRole(ESystemRole.SUPERADMIN),
          paramsValidator(IdParamSchema),
          bodyValidator(rolePermissionUpdateSchema),
        ],
      },
      {
        method: 'delete',
