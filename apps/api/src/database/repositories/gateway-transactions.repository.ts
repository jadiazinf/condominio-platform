...
import { gatewayTransactions } from '@database/drizzle/schema'
  ...
  implements IRepository<TGatewayTransaction, TGatewayTransactionCreate, TGatewayTransactionUpdate>
{
  ...
  protected mapToInsertValues(dto: TGatewayTransactionCreate): Record<string, unknown> {
    return {
  ...
  protected mapToUpdateValues(dto: TGatewayTransactionUpdate): Record<string, unknown> {
    const values: Record<string, unknown> = {}

    if (dto.externalTransactionId !== undefined) values.externalTransactionId = dto.externalTransactionId
   ...
   */
  async markVerified(id: string, externalTransactionId?: string): Promise<TGatewayTransaction | null> {
