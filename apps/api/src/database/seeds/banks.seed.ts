...
const VENEZUELAN_BANKS: TBankSeed[] = [
  {
    ...
    supportedPaymentMethods: VE_METHODS,
  },
  {
    code: '0104',
...
const INTERNATIONAL_BANKS: TBankSeed[] = [
  // US — Major Banks (most support wire, ACH, and Zelle)
  {
    ...
    supportedPaymentMethods: ['wire_transfer', 'ach', 'zelle'],
  },
  {
    code: 'CHASUS33',
    name: 'JPMorgan Chase',
  ...
  // Charles Schwab — brokerage, no Zelle
  {
    ...
    country: 'US',
    accountCategory: 'international',
    supportedPaymentMethods: ['wire_transfer', 'ach'],
  },
  ...
  // Zinli — digital wallet, wire transfer only
  {
    ...
    country: 'US',
    accountCategory: 'international',
    supportedPaymentMethods: ['wire_transfer'],
  },
  ...
  // Revolut — UK neobank, wire + wise
  {
    ...
    country: 'GB',
    accountCategory: 'international',
    supportedPaymentMethods: ['wire_transfer', 'wise'],
  },
...
export async function seedBanks(db: TDrizzleClient): Promise<void> {
  ...
  console.log(
    `[Seed] Upserted ${allBanks.length} banks (ON CONFLICT updates supported_payment_methods)`
  )
}
