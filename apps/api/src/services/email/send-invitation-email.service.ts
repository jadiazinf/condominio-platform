...
/**
 * Service for sending admin invitation emails.
 */
  ...
  implements IService<ISendInvitationEmailInput, TServiceResult<ISendInvitationEmailResult>>
{
  ...
  private generateEmailHtml(params: {
    ...
    const { recipientName, companyName, invitationLink, expiresAtFormatted } = params
...
<head>
  ...
  <title>Invitación para administrar ${companyName}</title>
</head>
...
Has sido invitado a administrar ${companyName} en nuestra plataforma de gestión de condominios.
