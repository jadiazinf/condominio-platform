export { GetBuildingsByCondominiumService } from './get-buildings-by-condominium.service'
export type { IGetBuildingsByCondominiumInput } from './get-buildings-by-condominium.service'
