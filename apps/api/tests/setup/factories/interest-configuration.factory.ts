...
export class InterestConfigurationFactory {
   ...
   */
  static create(overrides: Partial<TInterestConfigurationCreate> = {}): TInterestConfigurationCreate {
    return {
   ...
   */
  static simple(overrides: Partial<TInterestConfigurationCreate> = {}): TInterestConfigurationCreate {
    return this.create({
      interestType: 'simple',
      interestRate: '10.00',
      ...overrides,
   ...
   */
  static compound(overrides: Partial<TInterestConfigurationCreate> = {}): TInterestConfigurationCreate {
    return this.create({
   ...
   */
  static fixedAmount(overrides: Partial<TInterestConfigurationCreate> = {}): TInterestConfigurationCreate {
    return this.create({
