...
import { ReceiptDetailClient } from '../../receipts/[id]/components/ReceiptDetailClient'

import { getTranslations } from '@/libs/i18n/server'
import { getFullSession } from '@/libs/session'

export default async function MyReceiptDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const p = 'resident.receiptDetail'
  const translations = {
    title: t(`${p}.title`),
    back: t(`${p}.back`),
