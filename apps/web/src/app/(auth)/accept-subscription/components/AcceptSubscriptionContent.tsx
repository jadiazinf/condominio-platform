    ...
    async function validateToken() {
      try {
        ...
        const apiResponse = await client.get<{
          success: boolean
          data: TValidateSubscriptionResult
          error?: string
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="flex flex-col items-center pb-0">
          <div className="w-16 h-16 rounded-full bg-warning/10 flex items-center justify-center mb-4">
            ...
            >
              <path
                d="M12 15v2m0 0v2m0-2h2m-2 0H10m9.374-9.373a9 9 0 11-12.728 0"
                strokeLinecap="round"
        ...
        <CardBody className="flex flex-col items-center text-center gap-6">
          ...
          <Button as={Link} color="primary" href={`/auth?redirect=${redirectUrl}`} size="lg">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="flex flex-col items-center pb-0">
          ...
          <h1 className="text-xl font-semibold text-center">
            {t('subscription.accept.unauthorizedTitle')}
          </h1>
        </CardHeader>
        <CardBody className="flex flex-col items-center text-center gap-6">
