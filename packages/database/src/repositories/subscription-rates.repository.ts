...
import { subscriptionRates } from '../drizzle/schema'
    ...
    >
{
  ...
  protected override mapToInsertValues(dto: TSubscriptionRateCreate): Record<string, unknown> {
    return {
      name: dto.name,
  ...
  protected override mapToUpdateValues(dto: TSubscriptionRateUpdate): Record<string, unknown> {
