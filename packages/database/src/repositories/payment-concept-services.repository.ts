...
import { paymentConceptServices, condominiumServices } from '../drizzle/schema'
...
> {
  ...
  protected override mapToInsertValues(dto: TPaymentConceptServiceCreate): Record<string, unknown> {
    return {
