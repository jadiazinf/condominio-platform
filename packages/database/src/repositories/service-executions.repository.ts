...
import { serviceExecutions } from '../drizzle/schema'
    ...
    IRepositoryWithHardDelete<TServiceExecution, TServiceExecutionCreate, TServiceExecutionUpdate>
{
  ...
  protected override mapToInsertValues(dto: TServiceExecutionCreate): Record<string, unknown> {
    return {
  ...
  protected override mapToUpdateValues(dto: TServiceExecutionUpdate): Record<string, unknown> {
