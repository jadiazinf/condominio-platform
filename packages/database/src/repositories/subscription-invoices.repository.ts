...
import { subscriptionInvoices } from '../drizzle/schema'
  ...
  implements IRepository<TSubscriptionInvoice, TSubscriptionInvoiceCreate, TSubscriptionInvoiceUpdate>
{
  ...
  protected override mapToInsertValues(dto: TSubscriptionInvoiceCreate): Record<string, unknown> {
    return {
  ...
  protected override mapToUpdateValues(dto: TSubscriptionInvoiceUpdate): Record<string, unknown> {
